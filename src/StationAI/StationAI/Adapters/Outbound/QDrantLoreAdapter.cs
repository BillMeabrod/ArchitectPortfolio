...
public class QdrantLoreAdapter : ILoreRepository
{
    ...
    private const string CollectionName = "station-lore";
    private const int VectorSize = 3072;
    private const float SimilarityThreshold = 0.65f;

    public QdrantLoreAdapter(string dbConnectionString, string qdrantUrl, string qdrantApiKey, IEmbeddingService embeddingService)
    {
    ...
    public async Task DeleteAsync(int id)
    {
        ...
        await _qdrant.DeleteAsync(CollectionName, (ulong)id);
    }
